...
interface HeaderProps {
    ...
    className?: string;
    logo?: ReactNode;
    logoMinimal?: ReactNode;
    cta?: ReactNode;
}

export const Header = ({ items = headerNavItems, isFullWidth, isFloating, className, logo, logoMinimal, cta }: HeaderProps) => {
            ...
            <div className="flex size-full max-w-container flex-1 items-center pr-3 pl-4 md:px-8">
                ...
                >
                    <div className="flex flex-1 items-center gap-5">
                        {logo ?? <UntitledLogo className="h-7 md:max-lg:hidden" />}
                        {logoMinimal ?? <UntitledLogoMinimal className="hidden h-7 md:inline-block lg:hidden" />}
