...
<section class="relative pt-40 pb-8 bg-gradient-to-b from-gray-50 to-white">
    ...
    <div class="relative max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <h1 class="text-5xl sm:text-6xl font-black mt-3 mb-4 text-gray-900">Boek uw Taxi</h1>
        <p class="text-gray-500 text-lg">Vul het formulier in en wij nemen zo snel mogelijk contact met u op ter bevestiging.</p>
    </div>
</section>
...
<section class="py-16">
    <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="mb-8 bg-green-50 border border-green-200 rounded-2xl p-6 flex items-start gap-4">
            ...
            <div>
                <h3 class="text-green-700 font-bold mb-1">Boeking ontvangen!</h3>
            ...
            <form action="{{ route('reserveren.store') }}" method="POST" class="space-y-8">
                ...
                <div>
                    ...
                    <div class="space-y-4">
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            ...
                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-2">Tijdstip *</label>
                        ...
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-2">Ophaallocatie *</label>
                        ...
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-2">Bestemming *</label>
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-2">Aantal passagiers *</label>
                            ...
                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-2">Type rit *</label>
                ...
                <div>
                    <h2 class="text-lg font-bold text-gray-900 mb-6 flex items-center gap-3">
                        ...
                        Opmerkingen <span class="text-gray-400 font-normal text-sm">(optioneel)</span>
                    </h2>
                    <textarea name="notes" rows="3"
                        ...
                        placeholder="Bijv. vluchtnummer, speciale wensen...">{{ old('notes') }}</textarea>
        ...
        <div class="mt-8 grid grid-cols-1 sm:grid-cols-2 gap-4">
            <a href="tel:+31XXXXXXXXX" class="flex items-center gap-4 bg-white border border-gray-200 hover:border-[#f5c518]/40 rounded-2xl p-5 transition-all hover:-translate-y-0.5 group shadow-sm">
                ...
                <div>
                    <div class="text-gray-900 font-semibold text-sm">Liever bellen?</div>
            ...
            <div class="flex items-center gap-4 bg-white border border-gray-200 rounded-2xl p-5 shadow-sm">
                ...
                <div>
                    <div class="text-gray-900 font-semibold text-sm">24/7 Beschikbaar</div>
                    <div class="text-gray-400 text-xs">Dag en nacht bereikbaar</div>
                </div>
            </div>
        </div>
    </div>
