...
@section('title', __('site.diensten_meta_title'))
@section('description', __('site.diensten_meta_desc'))
...
<section class="relative pt-40 pb-24 bg-gradient-to-b from-gray-50 to-white">
    ...
    <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <span class="text-[#f5c518] text-sm font-semibold uppercase tracking-widest">{{ __('site.diensten_hero_label') }}</span>
        <h1 class="text-5xl sm:text-6xl font-black mt-3 mb-6 text-gray-900">{{ __('site.diensten_hero_title') }}</h1>
        <p class="text-gray-500 text-xl max-w-2xl mx-auto">{{ __('site.diensten_hero_sub') }}</p>
    </div>
</section>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div class="bg-white border border-gray-200 rounded-2xl p-8 shadow-sm flex flex-col">
                ...
                <h3 class="text-gray-900 font-bold text-xl mb-3">{{ __('site.diensten_airport_title') }}</h3>
                <p class="text-gray-500 text-sm leading-relaxed mb-6 flex-grow">{{ __('site.diensten_airport_desc') }}</p>
                <div class="flex flex-col gap-2">
                    <a href="{{ route('airport-service') }}" class="inline-flex items-center justify-center gap-2 bg-[#f5c518] hover:bg-yellow-400 text-black font-bold px-5 py-2.5 rounded-xl transition-all text-sm">
                        {{ __('site.diensten_airport_rates') }}
                    ...
                    <a href="{{ route('reserveren') }}" class="inline-flex items-center justify-center gap-2 bg-white border border-gray-200 hover:bg-gray-50 text-gray-700 font-semibold px-5 py-2.5 rounded-xl transition-all text-sm">
                        {{ __('site.diensten_airport_reserve') }}
                    </a>
                </div>
            </div>
            ...
            <div class="bg-white border border-gray-200 rounded-2xl p-8 shadow-sm flex flex-col">
                ...
                <h3 class="text-gray-900 font-bold text-xl mb-3">{{ __('site.diensten_biz_title') }}</h3>
                <p class="text-gray-500 text-sm leading-relaxed mb-6 flex-grow">{{ __('site.diensten_biz_desc') }}</p>
            ...
            <div class="bg-white border border-gray-200 rounded-2xl p-8 shadow-sm flex flex-col">
                ...
                <h3 class="text-gray-900 font-bold text-xl mb-3">{{ __('site.diensten_grp_title') }}</h3>
                <p class="text-gray-500 text-sm leading-relaxed mb-6 flex-grow">{{ __('site.diensten_grp_desc') }}</p>
                <a href="tel:+31XXXXXXXXX" class="inline-flex items-center gap-2 text-[#f5c518] text-sm font-semibold">
                    <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 24 24"><path d="M6.62 10.79c1.44 2.83 3.76 5.14 6.59 6.59l2.2-2.2c.27-.27.67-.36 1.02-.24 1.12.37 2.33.57 3.57.57.55 0 1 .45 1 1V20c0 .55-.45 1-1 1-9.39 0-17-7.61-17-17 0-.55.45-1 1-1h3.5c.55 0 1 .45 1 1 0 1.25.2 2.45.57 3.57.11.35.03.74-.25 1.02l-2.2 2.2z"/></svg>
                    {{ __('site.diensten_on_request') }}
                </a>
            ...
            <div class="bg-white border border-gray-200 rounded-2xl p-8 shadow-sm flex flex-col">
                ...
                <h3 class="text-gray-900 font-bold text-xl mb-3">{{ __('site.diensten_cus_title') }}</h3>
                <p class="text-gray-500 text-sm leading-relaxed mb-6 flex-grow">{{ __('site.diensten_cus_desc') }}</p>
                <a href="tel:+31XXXXXXXXX" class="inline-flex items-center gap-2 text-[#f5c518] text-sm font-semibold">
                    <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 24 24"><path d="M6.62 10.79c1.44 2.83 3.76 5.14 6.59 6.59l2.2-2.2c.27-.27.67-.36 1.02-.24 1.12.37 2.33.57 3.57.57.55 0 1 .45 1 1V20c0 .55-.45 1-1 1-9.39 0-17-7.61-17-17 0-.55.45-1 1-1h3.5c.55 0 1 .45 1 1 0 1.25.2 2.45.57 3.57.11.35.03.74-.25 1.02l-2.2 2.2z"/></svg>
                    {{ __('site.diensten_on_request') }}
                </a>
            ...
            <div class="bg-white border border-gray-200 rounded-2xl p-8 shadow-sm flex flex-col">
                ...
                <h3 class="text-gray-900 font-bold text-xl mb-3">{{ __('site.diensten_night_title') }}</h3>
                <p class="text-gray-500 text-sm leading-relaxed mb-6 flex-grow">{{ __('site.diensten_night_desc') }}</p>
                <a href="tel:+31XXXXXXXXX" class="inline-flex items-center gap-2 text-[#f5c518] text-sm font-semibold">
                    <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 24 24"><path d="M6.62 10.79c1.44 2.83 3.76 5.14 6.59 6.59l2.2-2.2c.27-.27.67-.36 1.02-.24 1.12.37 2.33.57 3.57.57.55 0 1 .45 1 1V20c0 .55-.45 1-1 1-9.39 0-17-7.61-17-17 0-.55.45-1 1-1h3.5c.55 0 1 .45 1 1 0 1.25.2 2.45.57 3.57.11.35.03.74-.25 1.02l-2.2 2.2z"/></svg>
                    {{ __('site.diensten_on_request') }}
                </a>
            ...
            <div class="bg-white border border-gray-200 rounded-2xl p-8 shadow-sm flex flex-col">
                ...
                <h3 class="text-gray-900 font-bold text-xl mb-3">{{ __('site.diensten_dist_title') }}</h3>
                <p class="text-gray-500 text-sm leading-relaxed mb-6 flex-grow">{{ __('site.diensten_dist_desc') }}</p>
                <a href="tel:+31XXXXXXXXX" class="inline-flex items-center gap-2 text-[#f5c518] text-sm font-semibold">
                    <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 24 24"><path d="M6.62 10.79c1.44 2.83 3.76 5.14 6.59 6.59l2.2-2.2c.27-.27.67-.36 1.02-.24 1.12.37 2.33.57 3.57.57.55 0 1 .45 1 1V20c0 .55-.45 1-1 1-9.39 0-17-7.61-17-17 0-.55.45-1 1-1h3.5c.55 0 1 .45 1 1 0 1.25.2 2.45.57 3.57.11.35.03.74-.25 1.02l-2.2 2.2z"/></svg>
                    {{ __('site.diensten_on_request') }}
                </a>
        ...
        <div class="mt-16 bg-[#f5c518] rounded-3xl p-10 text-center">
            <h3 class="text-2xl font-black mb-3 text-black">{{ __('site.diensten_cta_title') }}</h3>
            <p class="text-black/70 mb-6">{{ __('site.diensten_cta_sub') }}</p>
