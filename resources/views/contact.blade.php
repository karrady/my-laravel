    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="grid grid-cols-1 lg:grid-cols-5 gap-12">
            ...
            <div class="lg:col-span-2 space-y-6">
                ...
                <a href="mailto:info@taxicentrale.nl" class="flex items-start gap-4 bg-white border border-gray-200 hover:border-[#f5c518]/40 rounded-2xl p-6 transition-all hover:-translate-y-0.5 group shadow-sm">
                    <div class="w-12 h-12 bg-[#f5c518]/10 rounded-xl flex items-center justify-center flex-shrink-0 group-hover:bg-[#f5c518]/20 transition-colors">
                        <svg class="w-6 h-6 text-[#f5c518]" fill="currentColor" viewBox="0 0 24 24">
                ...
                <div class="flex items-start gap-4 bg-white border border-gray-200 rounded-2xl p-6 shadow-sm">
